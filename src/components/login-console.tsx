          ...
          <div className="flex min-h-[520px] flex-col justify-between">
            <div>
              ...
              <motion.p
                ...
                className="max-w-2xl text-2xl font-semibold leading-tight text-slate-100 sm:text-4xl"
              >
              ...
              >
                Plataforma operacional para auditar empresas, simular automatizaciones, visualizar presión, memoria,
                predicción y convertir procesos en arquitectura cognitiva vendible.
              </motion.p>
            </div>
          ...
          <form onSubmit={onSubmit} className="amber-panel border bg-black/30 p-5 shadow-amber">
            ...
            <div className="mt-8 space-y-4">
              <label className="block">
                <span className="mb-2 flex items-center gap-2 font-mono text-xs uppercase tracking-[0.22em] text-slate-400">
                  <UserRound className="h-4 w-4" /> Usuario
                </span>
                <input
                  value={username}
                  onChange={(event) => setUsername(event.target.value)}
                  className="w-full border border-plasma/25 bg-black/45 px-4 py-3 text-slate-100 outline-none transition focus:border-plasma focus:shadow-hud"
              ...
              <button
                type="submit"
                disabled={loading}
                className="group flex w-full items-center justify-center gap-3 border border-ambercore/50 bg-ambercore/15 px-4 py-4 font-mono text-xs uppercase tracking-[0.28em] text-ambercore shadow-amber transition hover:bg-ambercore hover:text-black disabled:opacity-60"
              >
            ...
            <div className="mt-8 border border-plasma/15 bg-plasma/5 p-4 font-mono text-[11px] leading-6 text-slate-400">
              PRIME visual layer: activo
              <br />
              Cognitive shell: sincronizada
              <br />
